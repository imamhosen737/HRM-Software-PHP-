                                    ...
                                    <tr>
                                        ...
                                        <td>
                                           ...
                                           <!--  <a href="" class="btn btn-sm btn-info" title="Edit"><i class="fas fa-edit"></i></a>
                                            ...
                                            <a href="C_update.php?id=<?php echo $c['id']; ?>" class="btn btn-sm btn-info"><i class="fas fa-edit"></i></a>


                  <a href="C_delete.php?id=<?php echo $c['id'];?>" class="btn btn-sm btn-danger" onclick="return confirm('Are you sure?')" ><i class="fas fa-trash"></i></a> 
